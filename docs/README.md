...
| [`07-technical-direction.md`](07-technical-direction.md) | Stack and architecture direction | Project-shaping |
...
Reserved: `09+` for future-phase scope documents (e.g., `09-mvp-scope.md` after `08-poc-scope.md` closes).
